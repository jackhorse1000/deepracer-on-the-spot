...
class Reward:
    ...
    def reward_function(self, params):
        ...
        MAX_SPEED = 4.0
        LOOKAHEAD_POINTS = 5
        optimal_speed = min(racing_track[closest_index][2], MAX_SPEED)
        ...
        try:
            ...
            reward_prediction = max(MINIMAL_REWARD, (-REWARD_PER_STEP_FOR_FASTEST_TIME*(FASTEST_TIME) /
        ...
        if racing_direction_diff(optimals[0:2], optimals_second[0:2], [x, y], heading) > 30:
